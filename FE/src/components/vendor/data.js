...
export const orders = [
    ...
    { id: "DH240607-028", customer: { name: "Lê Minh Cường", phone: "0934 111 222" }, product: "Tủ Quần Áo 4 Cánh", qty: 1, total: 8900000, date: "07/06/2026", time: "11:05", payment: { label: "VNPay", tone: "blue" }, status: { label: "Đang xử lý", tone: "orange" }, action: "detail" },
